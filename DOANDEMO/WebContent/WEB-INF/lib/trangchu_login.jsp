    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
            <ul class="nav navbar-nav">
                <li class="active"><a href="trangchu_login.jsp">Trang chủ</a></li>
                <li><a href="gioithieu_login.jsp">Giới thiệu</a></li>
                
                <li><a href="tailieu_login.jsp">Tài liệu</a></li>
                <li><a href="hotro_login.jsp">Hỗ trợ</a></li>
            </ul>

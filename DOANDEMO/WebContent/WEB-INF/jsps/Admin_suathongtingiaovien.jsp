    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="giaodien.html"><span class="glyphicon glyphicon-log-out"></span> Đăng xuất</a></li>
        ...
        <section class="features">
            ...
            <div class="container">
                <form action="UpdateUser_Controller" id="edituser" method="post">
                    ...
                    <input type="text" name="fullname" id="fullname" placeholder="JohnHand"/>
                    <label for="password">Password</label>
                    <input type="password" name="password" id="password"
                           placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;"/>
                    <label for="email">Email</label>
                    <input type="text" name="email" id="email" placeholder="John123@gmail.com"/>
                    <label for="birthday">BirthDay</label>
                    <input type="text" name="birthday" id="birthday" placeholder="23/7/1997"/>
                    <label for="sex">Sex</label>
                    <input type="text" name="sex" id="sex" placeholder="nam"/>
                ...
                <button type="submit" id="btncancel"
                        onclick="location.href='EditAdmin_User.jsp';" style="width: 100px;">CANCEL
                </button>
            </div>
        </section>
